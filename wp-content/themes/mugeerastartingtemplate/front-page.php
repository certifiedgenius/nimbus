<?php get_header() ;?>
	...
	<section class="md:container md:mx-auto">
		...
		<div class="container">
			...
			<section class="relative py-20 2xl:py-11 overflow-hidden"> <!--try to add in w-full relative in the class-->

				<div class="container px-3 mx-auto">


					<div class="w-full h-full bg-no-repeat bg-cover bg-left bg-fixed">
						<img class="" src="/wp-content/themes/mugeerastartingtemplate/assets/images/pierre.jpg" alt="Pierre blaché">
					</div>
...
<section class="md:container md:mx-auto container relative items-center w-full py-12 mx-auto md:px-12 lg:px-24 max-w-full">
	...
	<!-- Landing Page Featured Solutions section at the bottom-->
	<section class="md:container md:mx-auto body-font">
		<div class="container relative items-center mb-48 w-full py-6 mx-auto md:px-12 lg:px-24 max-w-full">


				<div class="container px-5 py-24 mx-auto">
					<div class="text-center mb-20">
						<h1 class="flex justify-center items-center py-2 text-5xl font-bold mb-1 mt-14">Featured</h1>
	...
	</div> <!--Maybe this does not have a family -->
<?php get_footer(); ?>